...
<div class="site-main">
    ...
    <!-- services-section -->
    <section id="services" class="ttm-row services_2-section vector_bg-img3 clearfix active">
        <div class="container">
            <div class="row"><!-- row -->
                <div class="col-lg-7 col-md-7 col-sm-10 m-auto">
                    ...
                    <div class="section-title with-desc text-center clearfix">
                        <div class="title-header">
                            <h5>Our Services</h5>
                            <h2 class="title">very experienced in every area of our business transactions <br/>
                                <span> Real Estate/Property development, Trading/Distributing of Petroleum Oil products and Gold Mining</span>
                            </h2>
                        </div>
