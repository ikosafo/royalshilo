            ...
            <div class="row"><!-- row -->
                <div class="col-lg-8 offset-lg-2">
                    <div class="text-center">
                        ...
                        <!-- section-title end -->
                        <div class="mt-40">
                            <a href="contact" class="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-btn-color-white">Contact
                                Us</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="res-991-mt-30">
                        ...
                        <div class="section-title with-desc clearfix">
                            ...
                            <div class="title-desc">
                                <p>
                                    A 100% Ghanaian owned incorporated company since 2014. Although young the company
                                    Executives are
                                    very experienced in every area of our business transactions, ie. Real
                                ...
                                <div class="featured-icon-box style3 left-icon icon-align-top">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc"><!-- featured desc -->
                                            <p>
                                                Imaginary that Royal Shilo Ghana Ltd translates to Reality in Real
                                                Estate/Property Development,
                                                Oil and Mining Gold..
                                            </p>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="featured-icon-box style3 left-icon icon-align-top">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc"><!-- featured desc -->
                                            <p>
                                                Our Commissioned commitment to serve our clients in Regional Africa and
                                                the Diaspora, with delivery of
                                                quality Housing, petroleum products in Oil as well as Gold. Royal Shilo
                                                Ghana Ltd, aspires to invest in
                                                Strategic immovable assets for sustainable business growth, maintaining
                ...
                <div class="history-slide owl-carousel" data-item="4" data-nav="false" data-dots="false" data-auto="true">
                    <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                        ...
                        <div class="ttm-history-box-details">
                            <div class="ttm-historybox-title"><h5>Real Estate/Property Development</h5></div><!-- historybox-title  -->
                            ...
                            <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-20"
                               href="realestate">Read More <i class="ti ti-angle-double-right"></i></a>
                        </div>
                    </div>
                    <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                        <div class="ttm-history-box-icon-wrapper"><!-- ttm-history-box-icon-wrapper  -->
                        ...
                        <div class="ttm-history-box-border"></div><!-- ttm-history-box-border  -->
                        <div class="ttm-history-box-details">
                            <div class="ttm-historybox-title"><h5>Trading & Distribution Of Petroleum Products</h5></div><!-- historybox-title  -->
                            <div class="ttm-historybox-description"><!-- description  -->
                                Strong relationships are central to our petroleum trading business
                            </div>
                            <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-20"
                               href="petroleum">Read More <i class="ti ti-angle-double-right"></i></a>
                        </div>
                    </div>
                    <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                        <div class="ttm-history-box-icon-wrapper"><!-- ttm-history-box-icon-wrapper  -->
                        ...
                        <div class="ttm-history-box-border"></div><!-- ttm-history-box-border  -->
                        <div class="ttm-history-box-details">
                            <div class="ttm-historybox-title"><h5>Import And Export Of General Goods</h5></div><!-- historybox-title  -->
                            <div class="ttm-historybox-description"><!-- description  -->
                                Royal Shilo Ghana Ltd. is a leading Supply and Distribution company in Ghana with partners in the
                            </div>
                            <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-20" href="generalgoods">Read More <i class="ti ti-angle-double-right"></i></a>
                        </div>
                    </div>
                    <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                        <div class="ttm-history-box-icon-wrapper"><!-- ttm-history-box-icon-wrapper  -->
                        ...
                        <div class="ttm-history-box-border"></div><!-- ttm-history-box-border  -->
                        <div class="ttm-history-box-details">
                            <div class="ttm-historybox-title"><h5>Gold Mining</h5></div><!-- historybox-title  -->
                            <div class="ttm-historybox-description"><!-- description  -->
                                Royal Shilo Ghana Ltd. is also into mining. It has been operating for over 6 years and evolved
                                over the years into what it is today
                            </div>
                            <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-20" href="goldmining">Read More <i class="ti ti-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div><!-- row end-->
