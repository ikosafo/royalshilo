...
<head>
    ...
    <meta name="keywords" content="Royal Shilo Ghana Real Estate Property"/>
    <meta name="description" content="ROYAL SHILO GHANA LTD - Company With a Difference"/>
    <meta name="author" content="http://www.royalshiloghana.com//"/>
                ...
                <div class="ttm-topbar-content">
                    ...
                    <div class="topbar-right text-right">
                        <ul class="top-contact">
                            <li><i class="fa fa-clock-o"></i>Office Hours : 08:00am - 5:00pm</li>
                        </ul>
                        <div class="ttm-social-links-wrapper list-inline">
                            <ul class="social-icons">
                                ...
                                <li><a href="#" class=" tooltip-bottom" data-tooltip="Google"><i class="fa fa-google"></i></a>
                                </li>
                            ...
                            <div id="site-navigation" class="site-navigation">
                                ...
                                <nav id="menu" class="menu">
                                    <ul class="dropdown">
                                        ...
                                        <li class="<?php echo($_SERVER['PHP_SELF'] == "/about.php" ? "active" : ""); ?>"><a href="about">About Us</a></li>
                                        <li class="<?php echo($_SERVER['PHP_SELF'] == "/services.php" ? "active" : ""); ?>"><a href="services">Services</a></li>
                                        <li class="<?php echo($_SERVER['PHP_SELF'] == "/contact.php" ? "active" : ""); ?>"><a href="contact">Contact Us</a></li>
                                    </ul>
                                </nav>
